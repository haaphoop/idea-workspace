...
import com.company.exception.UnsupportedOperation;
import com.company.adt.Vtime;
...
public class DirectGraph extends AbstractGraph {
	...
	public void criticalPath(){
		...
		for(it.first(); !it.isDone(); it.next()){	//初始化各点ve与vl，并生成逆拓扑序列
			Vertex v = (Vertex)it.currentItem();
			com.company.adt.Vtime time = new com.company.adt.Vtime(0,Integer.MAX_VALUE);//ve=0,vl=Integer.MAX_VALUE
			v.setAppObj(time);
